            ...
            <Section title="Footer">
              ...
              <div className="mt-4">
                <Input
                  ...
                  onChange={(v) => updateField('footer.info.mapEmbedUrl', v)}
                />
                <p className="text-xs text-gray-500 mt-1.5 ml-1">
                  <strong>How to get this:</strong> Go to Google Maps → Share → "Embed a map" → Copy the link inside the <code>src="..."</code> quotes.
                </p>
              </div>
